...
class defaultFormFiled extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color? color = darkModeOn ?const Color(0xff252A34) : kPrimaryLightColor;
    ...
    return TextFormField(
      ...
      style: TextStyle(
        color: darkModeOn ?const Color(0xffE9EAEF) : Colors.grey[900],
        fontSize: 17,
      ...
      decoration: InputDecoration(
        ...
        //   borderSide: BorderSide(color: Colors.red[700]!),
        // ),
        prefixIcon: Icon(fixIcon,color: kPrimaryColor,),
        suffixIcon: sufixpressd != null || suffix != null
            ? IconButton(
              highlightColor: Colors.transparent,
              splashColor: Colors.transparent,
              onPressed: () => sufixpressd!(),
               icon: Icon(suffix, color:kPrimaryColor),
        )
            : null,
      ),
    );
